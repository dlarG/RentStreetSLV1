  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-2 px-4 py-2 rounded-xl bg-white border border-ink/5 text-sm">
      ...
      <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4">
        {statsCards.map((stat) => {
          ...
          return (
            <div
              key={stat.label}
              className="bg-white rounded-2xl p-5 border border-ink/5 hover:shadow-lg hover:shadow-ink/5 transition-all duration-300"
            >
      ...
      <div className="grid lg:grid-cols-2 gap-6">
        ...
        <div className="bg-white rounded-2xl p-6 border border-ink/5">
          <div className="flex items-center justify-between mb-6">
            <div>
              <h3 className="font-display font-bold text-lg">Occupancy Rate</h3>
              <p className="text-sm text-ink/40">
                Monthly average across all properties
              </p>
            </div>
            ...
            <ResponsiveContainer width="100%" height="100%">
              <LineChart data={occupancyData}>
                ...
                <Line
                  ...
                  stroke="#0E5C56"
                  strokeWidth={2.5}
                  dot={{ fill: "#0E5C56", strokeWidth: 2, r: 4 }}
                  activeDot={{ r: 6, fill: "#0E5C56" }}
                />
              </LineChart>
            </ResponsiveContainer>
          </div>
        ...
        <div className="bg-white rounded-2xl p-6 border border-ink/5">
          <div className="flex items-center justify-between mb-6">
            <div>
              ...
              <p className="text-sm text-ink/40">Subscription & listing fees</p>
            </div>
            <div className="flex items-center gap-1 text-sm text-green-600 font-semibold">
              <TrendingUp size={16} />
              +18.3%
      ...
      <div className="bg-white rounded-2xl p-6 border border-ink/5">
        <div className="flex items-center justify-between mb-6">
          ...
          <button className="text-sm font-semibold text-bay hover:text-bay-deep transition-colors">
            View all
          </button>
        </div>
        <div className="space-y-3">
          {recentActivity.map((activity) => (
            <div
              key={activity.id}
              className="flex items-center gap-4 p-3 rounded-xl hover:bg-mist/50 transition-colors"
            >
              <div
              ...
              >
                ...
                {activity.type === "dispute" && <AlertCircle size={16} />}
                {activity.type === "approval" && <ClipboardCheck size={16} />}
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-xs text-ink/40">{activity.user}</p>
              </div>
